...
Pour que l'audio fonctionne sur le PWA GitHub Pages ou l'APK, `apps/api` doit etre disponible sur une URL HTTPS. Tu peux renseigner cette URL dans `Parametres` avec le champ `URL API Flowify yt-dlp`, ou dans la variable GitHub `FLOWIFY_API_URL`.
